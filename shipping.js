//CAMBIAR LAS REGIONES
  ...
  function hideFreeShipping() {
    ...
    if (!selectedRegion()) {
      // Hide Santiago
      $("#order_shipping_method_212445").parent().css('display','none')
    }else{
    	 $("#order_shipping_method_212445").parent().css('display','block')
    }
  }
  ...
  /// Función por comuna
    ...
    if( isSantiago ){
       // Visible Santiago
       $("#order_shipping_method_212445").parent().css('display','block')
       $("#order_shipping_method_212445").click();
      // Hide Starken
      ...
      $("#order_shipping_method_10120-service").click();
    }
  }
